...
* We are 95% confident that the true r-squared lies between `r round(CI_lower_r2,3)` and `r round(CI_upper_r2,3)`.
* We re 95% confident that the true value for log(beta0+beta1) lies between `r round(CI_lower,3)` and `r round(CI_upper,3)`.
