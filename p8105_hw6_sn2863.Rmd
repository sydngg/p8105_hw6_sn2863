...
#### Model including length at birth and gestational age
```{r}
...
#### Modeling including head circumference, length, sex, and all interactions (including the three-way interaction) 
...
Using the root-mean squared error (RSME) to compare the three models, it turns out that my model is actually pretty bad at predicting baby birthweights using the all the variables I included.
