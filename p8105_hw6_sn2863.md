...
intervals for the r-squared and log(beta0+beta1):
  ...
  - We are 95% confident that the true r-squared lies between 0.894 and
    0.928.
  - We re 95% confident that the true value for log(beta0+beta1) lies
    between 2.053 and 2.166.
